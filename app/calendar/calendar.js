...
.controller("CalendarCtrl", function($scope, $firebaseArray, $location) {
  ...
  //var ref = new Firebase(" https://your-butt.firebaseio.com/").orderByChild("start_time").startAt(today);
  //usable but redundant, see ng-if >=today in ngrepeat

  var ref = new Firebase("replace"); //firebase reference
